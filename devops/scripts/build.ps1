# Build script for {{ProjectEgenesisName}} application
...
$projectFile = Join-Path $projectDir "src\{{ProjectEgenesisName}}.App\{{ProjectEgenesisName}}.App.csproj"
...
Write-Host ">>> Building {{ProjectEgenesisName}} application..." -ForegroundColor Cyan
...
dotnet publish $projectFile `
    ...
    -p:AssemblyName= { { ProjectEgenesisName } } `
